// Code generated by " ../../base/gtl/generate.py --output=record_pool.go --prefix=Record -DELEM=*RecordWithScratchBuf --package=sam ../../base/gtl/randomized_freepool.go.tpl ". DO NOT EDIT.
...
type RecordpoolLocalInner struct {
	private     [RecordmaxPrivateElems]*RecordWithScratchBuf // Can be used only by the respective P.
	privateSize int

	shared     []*RecordWithScratchBuf // Can be used by any P.
...
func (p *RecordFreePool) Get() *RecordWithScratchBuf {
	l := p.pin()
	var x *RecordWithScratchBuf
	done := false
	if l.privateSize > 0 {
		l.privateSize--
		x = l.private[l.privateSize]
		var empty *RecordWithScratchBuf
