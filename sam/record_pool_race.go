// Code generated by " ../../base/gtl/generate.py --output=record_pool_race.go --prefix=Record -DELEM=*Record --package=sam ../../base/gtl/randomized_freepool_race.go.tpl ". DO NOT EDIT.
